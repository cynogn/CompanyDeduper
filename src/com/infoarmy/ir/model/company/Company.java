...
import com.infoarmy.ir.cache.base.Cacheable;
import com.infoarmy.ir.common.CompanyStatus;
import com.infoarmy.ir.model.BaseModel;
...
public class Company extends BaseModel implements Cacheable {
	/**
	 * 
	 */
	...
	private CompanyPriorityType priority;
	private String logo;
	...
	public CompanyPriorityType getPriority() {
		return priority;
	}

	public void setPriority(CompanyPriorityType priority) {
